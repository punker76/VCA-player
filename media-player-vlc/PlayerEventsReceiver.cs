...
namespace DZ.MediaPlayer {
    ...
    /// This is not interface because we need to implement some thread safety checks here, but later.
    /// TODO: We should restrict calling some Vlc methods from these methods
    /// TODO: Consider using interface if not
    /// </summary>
